...
public class DateUtil {
	...
	public static String [] monthsTR = {"", "Ocak", "Şubat", "Mart", "Nisan", "Mayıs", "Haziran", "Temmuz", "Ağustos", "Eylül",
												"Ekim", "Kasım", "Aralık"};
	...
	public static void printDateEN(int day, int month, int year)
	{
		...
		System.out.println(isWeekend(day, month, year) ? "Today is a course day?" : "Course day is coming");
	}
