...
public class StringUtil {
	...
	public static String alphabetEN = "abcdefghijklmnopqrstuwxvyz";
	public static String alphabetCapitalTR = "ABCÇDEFGĞHIİJKLMNOÖPRSŞTUÜVYZ";
	public static String alphabetCapitalEN = "ABCDEFGHIJKLMNOPQRSTUWXVYZ";
	...
	public static void fillRandomTexts(Random r, String [] s, int min, int bound, String sourceText)
	{
		for (int i = 0; i < s.length; ++i)
			s[i] = getRandomText(r, r.nextInt(min, bound), sourceText);
	}


	public static void fillRandomTexts(Random r, String [] s, int n, String sourceText)
	{
		for (int i = 0; i < s.length; ++i)
			s[i] = getRandomText(r, n, sourceText);
	}

	public static void fillRandomTextsTR(Random r, String [] s, int min, int bound)
	{
		fillRandomTexts(r, s, min, bound, alphabetAllTR);
	}


	public static void fillRandomTextsTR(Random r, String [] s, int n)
	{
		fillRandomTexts(r, s, n, alphabetAllTR);
	}

	public static void fillRandomTextsEN(Random r, String [] s, int min, int bound)
	{
		fillRandomTexts(r, s, min, bound, alphabetAllEN);
	}


	public static void fillRandomTextsEN(Random r, String [] s, int n)
	{
		fillRandomTexts(r, s, n, alphabetAllEN);
	}
